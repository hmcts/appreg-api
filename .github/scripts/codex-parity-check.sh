...
ISSUE_URL="${ISSUE_URL}" \
GITHUB_REPOSITORY="${GITHUB_REPOSITORY:-hmcts/appreg-api}" \
LEGACY_SNAPSHOT_DIR="${legacy_snapshot_dir}" \
...
Task:
Compare the Jira ticket against the legacy Apps Reg source snapshot and the modern backend repository.
