...
#			NULL or NOT NULL, whether the field is remapped, and
#			the masking function (or NONE)
#			e.g. abc:VARCHAR:VARCHAR(10):N:Y:NONE is a field called 
#			abc which is a VARCHAR, a VARCHAR(10) in Postgres and 
#			nulls not allowed (NOT NULL), the field is remapped
#			in postgres, and there is no masking function to be
#			applied when masking the data
APPLICATION_CODES_FIELDS='AC_ID:NUMBER:NUMERIC:N:N:NONE;APPLICATION_CODE:VARCHAR:VARCHAR(10):N:N:NONE;APPLICATION_CODE_TITLE:VARCHAR:VARCHAR(500):N:N:NONE;APPLICATION_CODE_WORDING:CLOB:TEXT:N:N:NONE;APPLICATION_LEGISLATION:CLOB:TEXT:Y:N:NONE;FEE_DUE:CHAR:CHAR(1):N:N:NONE;APPLICATION_CODE_RESPONDENT:CHAR:CHAR(1):N:N:NONE;AC_DESTINATION_EMAIL_ADDRESS_1:VARCHAR:VARCHAR(253):Y:N:NONE;AC_DESTINATION_EMAIL_ADDRESS_2:VARCHAR:VARCHAR(253):Y:N:NONE;APPLICATION_CODE_START_DATE:DATE:TEXT:N:N:NONE;APPLICATION_CODE_END_DATE:DATE:TEXT:Y:N:NONE;BULK_RESPONDENT_ALLOWED:CHAR:CHAR(1):N:N:NONE;VERSION:NUMBER:NUMERIC:N:N:NONE;CHANGED_BY:NUMBER:NUMERIC:N:N:NONE;CHANGED_DATE:DATE:TEXT:N:N:NONE;USER_NAME:VARCHAR:VARCHAR(250):Y:N:NONE;AC_FEE_REFERENCE:VARCHAR:VARCHAR(12):Y:N:NONE';

APPLICATION_LISTS_FIELDS="AL_ID:NUMBER:NUMERIC:N:N:NONE;APPLICATION_LIST_STATUS:VARCHAR:VARCHAR(7):Y:N:NONE;APPLICATION_LIST_DATE:DATE:TIMESTAMP:N:N:NONE;APPLICATION_LIST_TIME:TIMESTAMP:TIMESTAMP:N:N:NONE;COURTHOUSE_CODE:VARCHAR:VARCHAR(10):Y:N:NONE;OTHER_COURTHOUSE:VARCHAR:VARCHAR(200):Y:N:NONE;LIST_DESCRIPTION:VARCHAR:VARCHAR(200):N:N:DBMS_RANDOM.STRING('',NVL(LENGTH(LIST_DESCRIPTION),0));VERSION:NUMBER:NUMERIC:N:N:NONE;CHANGED_BY:NUMBER:NUMERIC:N:N:NONE;CHANGED_DATE:DATE:TIMESTAMP:N:N:NONE;USER_NAME:VARCHAR:VARCHAR(250):Y:N:NONE;COURTHOUSE_NAME:VARCHAR:VARCHAR(200):Y:N:NONE;DURATION_HOUR:NUMBER:SMALLINT:Y:N:NONE;DURATION_MINUTE:NUMBER:SMALLINT:Y:N:NONE;CJA_CJA_ID:NUMBER:NUMERIC:Y:N:NONE";

APPLICATION_LIST_ENTRIES_FIELDS="ALE_ID:NUMBER:NUMERIC:N:N:NONE;AL_AL_ID:NUMBER:NUMERIC:N:N:NONE;SA_SA_ID:NUMBER:NUMERIC:Y:N:NONE;AC_AC_ID:NUMBER:NUMERIC:N:N:NONE;A_NA_ID:NUMBER:NUMERIC:Y:N:NONE;R_NA_ID:NUMBER:NUMERIC:Y:N:NONE;NUMBER_OF_BULK_RESPONDENTS:NUMBER:SMALLINT:Y:N:NONE;APPLICATION_LIST_ENTRY_WORDING:CLOB:TEXT:N:N:APPREGISTER.MASK_BRACES(APPLICATION_LIST_ENTRY_WORDING);CASE_REFERENCE:VARCHAR:VARCHAR(15):Y:N:DBMS_RANDOM.STRING('',NVL(LENGTH(CASE_REFERENCE),0));ACCOUNT_NUMBER:VARCHAR:VARCHAR(20):Y:N:DBMS_RANDOM.STRING('',NVL(LENGTH(ACCOUNT_NUMBER),0));ENTRY_RESCHEDULED:CHAR:CHAR(1):N:N:NONE;NOTES:VARCHAR:VARCHAR(4000):Y:N:DBMS_RANDOM.STRING('',NVL(LENGTH(NOTES),0));VERSION:NUMBER:NUMERIC:N:N:NONE;CHANGED_BY:NUMBER:NUMERIC:N:N:NONE;CHANGED_DATE:DATE:TIMSTAMP:N:N:NONE;BULK_UPLOAD:VARCHAR:VARCHAR(1):Y:N:NONE;USER_NAME:VARCHAR:VARCHAR(250):Y:N:NONE;SEQUENCE_NUMBER:NUMBER:SMALLINT:N:N:NONE;TCEP_STATUS:VARCHAR:VARCHAR(2):Y:N:NONE;MESSAGE_UUID:VARCHAR:VARCHAR(36):Y:N:NONE;RETRY_COUNT:VARCHAR:VARCHAR(36):Y:N:NONE;LODGEMENT_DATE:DATE:TIMESTAMP:N:N:NONE";

APPLICATION_REGISTER_FIELDS="AR_ID:NUMBER:NUMERIC:N:N:NONE;AL_AL_ID:NUMBER:NUMERIC:N:N:NONE;TEXT:CLOB:TEXT:Y:N:DBMS_RANDOM.STRING('',500) AS TEXT;CHANGED_BY:NUMBER:NUMERIC:N:N:NONE;CHANGED_DATE:TIMESTAMP:TIMESTAMP:N:N:NONE;USER_NAME:VARCHAR:VARCHAR(250):Y:N:NONE";

APPREG_USER_MAPPING_FIELDS='LEGACY_CHANGED_BY:NUMBER:NUMERIC:N:N:NONE;MODERN_CHANGED_BY:VARCHAR:VARCHAR(73):N:N:NONE';

APP_LIST_ENTRY_FEE_ID_FIELDS='ALE_ALE_ID:NUMBER:NUMERIC:N:N:NONE;FEE_FEE_ID:NUMBER:NUMERIC:N:N:NONE;VERSION:NUMBER:NUMERIC:N:N:NONE;CHANGED_BY:NUMBER:NUMERIC:N:N:NONE;CHANGED_DATE:DATE:TIMESTAMP:N:N:NONE;USER_NAME:VARCHAR:VARCHAR(250):N:N:NONE';

APP_LIST_ENTRY_FEE_STATUS_FIELDS="ALEFS_ID:NUMBER:NUMERIC:N:N:NONE;ALEFS_ALE_ID:NUMBER:NUMERIC:N:N:NONE;ALEFS_PAYMENT_REFERENCE:VARCHAR:VARCHAR(15):Y:N:DBMS_RANDOM.STRING('',NVL(LENGTH(ALEFS_PAYMENT_REFERENCE),0));ALEFS_FEE_STATUS:VARCHAR:VARCHAR(1):N:N:NONE;ALEFS_FEE_STATUS_DATE:DATE:TIMESTAMP:N:N:NONE;ALEFS_VERSION:NUMBER:NUMERIC:N:N:NONE;ALEFS_CHANGED_BY:NUMBER:NUMERIC:N:N:NONE;ALEFS_CHANGED_DATE:DATE:TIMESTAMP:N:N:NONE;ALEFS_USER_NAME:VARCHAR:VARCHAR(250):N:N:NONE;ALEFS_STATUS_CREATION_DATE:DATE:TIMESTAMP:Y:N:NONE";

APP_LIST_ENTRY_OFFICIAL_FIELDS="ALEO_ID:NUMBER:NUMERIC:N:N:NONE;ALE_ALE_ID:NUMBER:NUMERIC:N:N:NONE;TITLE:VARCHAR:VARCHAR(100):Y:N:NONE;FORENAME:VARCHAR:VARCHAR(100):Y:N:DBMS_RANDOM.STRING('',NVL(LENGTH(FORENAME),0));SURNAME:VARCHAR:VARCHAR(100):Y:N:DBMS_RANDOM.STRING('',NVL(LENGTH(SURNAME),0));OFFICIAL_TYPE:VARCHAR:VARCHAR(1):N:N:NONE;CHANGED_BY:NUMBER:NUMERIC:N:N:NONE;CHANGED_DATE:DATE:TIMESTAMP:N:N:NONE;USER_NAME:VARCHAR:VARCHAR(250):N:N:NONE";

APP_LIST_ENTRY_RESOLUTIONS_FIELDS="ALER_ID:NUMBER:NUMERIC:N:N:NONE;RC_RC_ID:NUMBER:NUMERIC:N:N:NONE;ALE_ALE_ID:NUMBER:NUMERIC:N:N:NONE;AL_ENTRY_RESOLUTION_WORDING:CLOB:TEXT:N:N:APPREGISTER.MASK_BRACES(AL_ENTRY_RESOLUTION_WORDING);AL_ENTRY_RESOLUTION_OFFICER:VARCHAR:VARCHAR(1000):N:N:DBMS_RANDOM.STRING('',NVL(LENGTH(AL_ENTRY_RESOLUTION_OFFICER),0));VERSION:NUMBER:NUMERIC:N:N:NONE;CHANGED_BY:NUMBER:NUMERIC:N:N:NONE;CHANGED_DATE:DATE:TIMESTAMP:N:N:NONE;USER_NAME:VARCHAR:VARCHAR(250):Y:N:NONE";

CRIMINAL_JUSTICE_AREA_FIELDS='CJA_ID:NUMBER:NUMERIC:N:N:NONE;CJA_CODE:VARCHAR:VARCHAR(2):N:N:NONE;CJA_DESCRIPTION:VARCHAR:VARCHAR(35):N:N:NONE';

DATA_AUDIT_FIELDS="DATA_ID:NUMBER:NUMERIC:N:N:NONE;SCHEMA_NAME:VARCHAR:VARCHAR(32):N:N:NONE;TABLE_NAME:VARCHAR:VARCHAR(32):N:N:NONE;COLUMN_NAME:VARCHAR:VARCHAR(32):N:N:NONE;OLD_VALUE:VARCHAR:VARCHAR(4000):Y:N:NONE;NEW_VALUE:VARCHAR:VARCHAR(4000):Y:N:NONE;USER_ID:VARCHAR:VARCHAR(32):Y:N:NONE;LINK:VARCHAR:VARCHAR(100):Y:N:NONE;CREATED_DATE:TIMESTAMP:TIMESTAMP:N:N:NONE;OLD_CLOB_VALUE:CLOB:TEXT:Y:N:NONE;NEW_CLOB_VALUE:CLOB:TEXT:Y:N:NONE;RELATED_KEY:NUMBER:NUMERIC:Y:N:NONE;UPDATE_TYPE:VARCHAR:VARCHAR(1):N:N:NONE;DATA_TYPE:VARCHAR:VARCHAR(1000):Y:N:NONE;CASE_ID:NUMBER:NUMERIC:Y:N:NONE;RELATED_ITEMS_IDENTIFIER:VARCHAR:VARCHAR(30):Y:N:NONE;RELATED_ITEMS_IDENTIFIER_INDEX:VARCHAR:VARCHAR(30):Y:N:NONE;EVENT_NAME:VARCHAR:VARCHAR(100):Y:N:NONE;USER_NAME:VARCHAR:VARCHAR(250):Y:N:NONE";

FEE_FIELDS='FEE_ID:NUMBER:NUMERIC:N:N:NONE;FEE_REFERENCE:VARCHAR:VARCHAR(12):N:N:NONE;FEE_DESCRIPTION:VARCHAR:VARCHAR(250):N:N:NONE;FEE_VALUE:NUMBER:DOUBLE PRECISION:N:N:NONE;FEE_START_DATE:DATE:TIMESTAMP:N:N:NONE;FEE_END_DATE:DATE:TIMESTAMP:Y:N:NONE;FEE_VERSION:NUMBER:NUMERIC:N:N:NONE;FEE_CHANGED_BY:NUMBER:NUMERIC:N:N:NONE;FEE_CHANGED_DATE:DATE:TIMESTAMP:N:N:NONE;FEE_USER_NAME:VARCHAR:VARCHAR(250):N:N:NONE';

NAME_ADDRESS_FIELDS="NA_ID:NUMBER:NUMERIC:N:N:NONE;CODE:VARCHAR:VARCHAR(10):Y:N:NONE;NAME:VARCHAR:VARCHAR(100):Y:N:DBMS_RANDOM.STRING('',NVL(LENGTH(NAME),0));TITLE:VARCHAR:VARCHAR(100):Y:N:NONE;FORENAME_1:VARCHAR:VARCHAR(100):Y:Y:DBMS_RANDOM.STRING('',NVL(LENGTH(FORENAME_1),0));FORENAME_2:VARCHAR:VARCHAR(100):Y:Y:DBMS_RANDOM.STRING('',NVL(LENGTH(FORENAME_2),0));FORENAME_3:VARCHAR:VARCHAR(100):Y:Y:DBMS_RANDOM.STRING('',NVL(LENGTH(FORENAME_3),0));SURNAME:VARCHAR:VARCHAR(100):Y:Y:DBMS_RANDOM.STRING('',NVL(LENGTH(FORENAME_4),0));ADDRESS_L1:VARCHAR:VARCHAR(35):N:N:DBMS_RANDOM.STRING('',NVL(LENGTH(ADDRESS_L1),0));ADDRESS_L2:VARCHAR:VARCHAR(35):Y:N:DBMS_RANDOM.STRING('',NVL(LENGTH(ADDRESS_L2),0));ADDRESS_L3:VARCHAR:VARCHAR(35):Y:N:DBMS_RANDOM.STRING('',NVL(LENGTH(ADDRESS_L3),0));ADDRESS_L4:VARCHAR:VARCHAR(35):Y:N:DBMS_RANDOM.STRING('',NVL(LENGTH(ADDRESS_L4),0));ADDRESS_L5:VARCHAR:VARCHAR(35):Y:N:DBMS_RANDOM.STRING('',NVL(LENGTH(ADDRESS_L5),0));POSTCODE:VARCHAR:VARCHAR(8):Y:N:DBMS_RANDOM.STRING('',3)||' '||DBMS_RANDOM.STRING('',3);EMAIL_ADDRESS:VARCHAR:VARCHAR(253):Y:N:DBMS_RANDOM.STRING('l',8)||'@'||DBMS_RANDOM.STRING('l',7)||'.com';TELEPHONE_NUMBER:VARCHAR:VARCHAR(20):Y:N:NVL2(TELEPHONE_NUMBER,'01'||ROUND(DBMS_RANDOM.VALUE(100000000,999999999)),'');MOBILE_NUMBER:VARCHAR:VARCHAR(20):Y:N:NVL2(MOBILE_NUMBER,'07'||ROUND(DBMS_RANDOM.VALUE(100000000,999999999)),'');VERSION:NUMBER:NUMERIC:Y:N:NONE;CHANGED_BY:NUMBER:NUMERIC:N:N:NONE;CHANGED_DATE:DATE:TIMESTAMP:N:N:NONE;USER_NAME:VARCHAR:VARCHAR(250):Y:N:NONE;DATE_OF_BIRTH:DATE:TIMESTAMP:Y:N:NONE;DMS_ID:VARCHAR:VARCHAR(20):Y:N:NONE";

RESOLUTION_CODES_FIELDS="RC_ID:NUMBER:NUMERIC:N:N:NONE;RESOLUTION_CODE:VARCHAR:VARCHAR(10):N:N:NONE;RESOLUTION_CODE_TITLE:VARCHAR:VARCHAR(500):N:N:NONE;RESOLUTION_CODE_WORDING:CLOB:TEXT:N:N:NONE;RESOLUTION_LEGISLATION:CLOB:TEXT:Y:N:NONE;RC_DESTINATION_EMAIL_ADDRESS_1:VARCHAR:VARCHAR(253):Y:N:NONE;RC_DESTINATION_EMAIL_ADDRESS_2:VARCHAR:VARCHAR(253):Y:N:NONE;RESOLUTION_CODE_START_DATE:DATE:TIMESTAMP:N:N:NONE;RESOLUTION_CODE_END_DATE:DATE:TIMESTAMP:Y:N:NONE;VERSION:NUMBER:NUMERIC:N:N:NONE;CHANGED_BY:NUMBER:NUMERIC:N:N:NONE;CHANGED_DATE:DATE:TIMESTAMP:N:N:NONE;USER_NAME:VARCHAR:VARCHAR(250):Y:N:NONE";

STANDARD_APPLICANTS_FIELDS="SA_ID:NUMBER:NUMERIC:N:N:NONE;STANDARD_APPLICANT_CODE:VARCHAR:VARCHAR(10):N:N:DBMS_RANDOM.STRING('',NVL(LENGTH(STANDARD_APPLICANT_CODE),0));STANDARD_APPLICANT_START_DATE:DATE:TIMESTAMP:N:N:NONE;STANDARD_APPLICANT_END_DATE:DATE:TIMESTAMP:Y:N:NONE;VERSION:NUMBER:NUMERIC:N:N:NONE;CHANGED_BY:NUMBER:NUMERIC:N:N:NONE;CHANGED_DATE:DATE:TIMESTAMP:N:N:NONE;USER_NAME:VARCHAR:VARCHAR(250):Y:N:NONE;NAME:VARCHAR:VARCHAR(100):Y:N:DBMS_RANDOM.STRING('',NVL(LENGTH(NAME),0));TITLE:VARCHAR:VARCHAR(100):Y:N:NONE;FORENAME_1:VARCHAR:VARCHAR(100):Y:N:DBMS_RANDOM.STRING('',NVL(LENGTH(FORENAME_1),0));FORENAME_2:VARCHAR:VARCHAR(100):Y:N:DBMS_RANDOM.STRING('',NVL(LENGTH(FORENAME_2),0));FORENAME_3:VARCHAR:VARCHAR(100):Y:N:DBMS_RANDOM.STRING('',NVL(LENGTH(FORENAME_3),0));SURNAME:VARCHAR:VARCHAR(100):Y:N:DBMS_RANDOM.STRING('',NVL(LENGTH(SURNAME),0));ADDRESS_L1:VARCHAR:VARCHAR(35):N:N:DBMS_RANDOM.STRING('',NVL(LENGTH(ADDRESS_L1),0));ADDRESS_L2:VARCHAR:VARCHAR(35):Y:N:DBMS_RANDOM.STRING('',NVL(LENGTH(ADDRESS_L2),0));ADDRESS_L3:VARCHAR:VARCHAR(35):Y:N:DBMS_RANDOM.STRING('',NVL(LENGTH(ADDRESS_L3),0));ADDRESS_L4:VARCHAR:VARCHAR(35):Y:N:DBMS_RANDOM.STRING('',NVL(LENGTH(ADDRESS_L4),0));ADDRESS_L5:VARCHAR:VARCHAR(35):Y:N:DBMS_RANDOM.STRING('',NVL(LENGTH(ADDRESS_L5),0));POSTCODE:VARCHAR:VARCHAR(8):Y:N:NVL2(POSTCODE,DBMS_RANDOM.STRING('',3)||' '||DBMS_RANDOM.STRING('',3),'');EMAIL_ADDRESS:VARCHAR:VARCHAR(253):Y:N:NVL2(EMAIL_ADDRESS,DBMS_RANDOM.STRING('l',8)||'@'||DBMS_RANDOM.STRING('l',7)||'.com','');TELEPHONE_NUMBER:VARCHAR:VARCHAR(20):Y:N:NVL2(TELEPHONE_NUMBER,'01'||ROUND(DBMS_RANDOM.VALUE(100000000,999999999)),'');MOBILE_NUMBER:VARCHAR:VARCHAR(20):Y:N:NVL2(MOBILE_NUMBER,'07'||ROUND(DBMS_RANDOM.VALUE(100000000,999999999)),'')";

NATIONAL_COURT_HOUSES_FIELDS='NCH_ID:NUMBER:BIGINT:N:N:NONE;COURTHOUSE_NAME:VARCHAR:VARCHAR(100):N:N:NONE;VERSION_NUMBER:NUMBER:NUMERIC:N:N:NONE;CHANGED_BY:NUMBER:BIGINT:N:N:NONE;CHANGED_DATE:DATE:TIMESTAMP:N:N:NONE;COURT_TYPE:VARCHAR:VARCHAR(10):N:N:NONE;START_DATE:DATE:TIMESTAMP:N:N:NONE;END_DATE:DATE:TIMESTAMP:Y:N:NONE;LOC_LOC_ID:NUMBER:BIGINT:Y:N:NONE;PSA_PSA_ID:NUMBER:BIGINT:Y:N:NONE;COURT_LOCATION_CODE:VARCHAR:VARCHAR(10):Y:N:NONE;SL_COURTHOUSE_NAME:VARCHAR:VARCHAR(100):Y:N:NONE;NORG_ID:NUMBER:BIGINT:Y:N:NONE';
