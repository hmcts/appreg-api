...
#						per ARCPOC-1684
# 6.0		22/09/2026	Matthew Harman	Added data_audit for 
#						ARCPOC-1826 
#
...
#			
TABLES_TO_EXTRACT='APPREGISTER.APPLICATION_CODES.CHANGED_DATE¬APPREGISTER.APPLICATION_LISTS.CHANGED_DATE¬APPREGISTER.APPLICATION_LIST_ENTRIES.CHANGED_DATE¬APPREGISTER.APPLICATION_REGISTER.CHANGED_DATE¬APPREGISTER.APP_LIST_ENTRY_FEE_ID.CHANGED_DATE¬APPREGISTER.APP_LIST_ENTRY_FEE_STATUS.ALEFS_CHANGED_DATE¬APPREGISTER.APP_LIST_ENTRY_OFFICIAL.CHANGED_DATE¬APPREGISTER.APP_LIST_ENTRY_RESOLUTIONS.CHANGED_DATE¬APPREGISTER.CRIMINAL_JUSTICE_AREA.NO_FIELD¬APPREGISTER.FEE.FEE_CHANGED_DATE¬APPREGISTER.NAME_ADDRESS.CHANGED_DATE¬APPREGISTER.RESOLUTION_CODES.CHANGED_DATE¬APPREGISTER.STANDARD_APPLICANTS.CHANGED_DATE¬LIBRA.NATIONAL_COURT_HOUSES.CHANGED_DATE¬APPREGISTER.APPREG_USER_MAPPING.NO_FIELD¬APPREGISTER.DATA_AUDIT.CREATED_DATE';
...
DATA_AUDIT_STRUCTURE='DATA_ID:NUMBER:NULL¬SCHEMA_NAME:VARCHAR:NULL¬TABLE_NAME:VARCHAR:NULL¬COLUMN_NAME:VARCHAR:NULL¬OLD_VALUE:VARCHAR:NULL¬NEW_VALUE:VARCHAR:NULL¬USER_ID:VARCHAR:NULL¬LINK:VARCHAR:NULL¬CREATED_DATE:DATE:NULL¬OLD_CLOB_VALUE:CLOB:NULL¬NEW_CLOB_VALUE:CLOB:NULL¬RELATED_KEY:NUMBER:NULL¬UPDATE_TYPE:VARCHAR:NULL¬DATA_TYPE:VARCHAR:NULL¬CASE_ID:NUMBER:NULL¬RELATED_ITEMS_IDENTIFIER:VARCHAR:NULL¬RELATED_ITEMS_IDENTIFIER_INDEX:VARCHAR:NULL¬EVENT_NAME:VARCHAR:NULL¬USER_NAME:VARCHAR:NULL';
...
do
	if [ ${tables_to_extract} == "APPREGSITER.DATA_AUDIT" ] && [ ${DATA_AUDIT_INCLUDE} = false ]; then
		...
		case $table_name in
				...
				data_filter="";
       		 	...
       		 	DATA_AUDIT)
		               	echo "in DATA_AUDIT"
       		        	table_structure=$DATA_AUDIT_STRUCTURE;
