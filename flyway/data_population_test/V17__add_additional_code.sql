...
VALUES
  ...
  (44, 'ZS99007','Copy documents','Application for a warrant to enter premises at {TEXT|Premises Address|20} for date {DATE|Premises Date|10}','',1,1,'','',TIMESTAMP '2016-01-01 00:00:00',NULL,0, 0, 0, '2016-01-01 00:00:00', 'admin', 'CO1.1');
