...
public class StandardApplicantControllerExportTest  extends AbstractStandardApplicantControllerCrudTest {
    ...
    void testExportCsvCodeAndNameFailure() throws Exception {
        ...
        Assertions.assertEquals("Either code or name must be provided, but not both", problemDetail.getDetail());
    ...
    void testExportCsvNoResultsFoundFailure() throws Exception {
        ...
        ProblemDetail problemDetail = responseSpec.as(ProblemDetail.class);
        Assertions.assertEquals("No records found for the provided code or name", problemDetail.getDetail());
    }
    ...
    void testExportCsvNoParametersFailure() throws Exception {
        ...
        ProblemDetail problemDetail = responseSpec.as(ProblemDetail.class);
        Assertions
            .assertEquals("Constraints failed for fields:" +
