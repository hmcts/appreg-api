...
@Builder
@Getter
public class SearchWarrantsReportParameterAudit implements Auditable {
    ...
    public static SearchWarrantsReportParameterAudit from(SearchWarrantsReportFilterDto filter) {
        LegacyReportLocation location = filter.getLocation();
        return SearchWarrantsReportParameterAudit.builder()
