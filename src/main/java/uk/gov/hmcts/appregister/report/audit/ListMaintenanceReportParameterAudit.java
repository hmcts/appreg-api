...
@Builder
@Getter
public class ListMaintenanceReportParameterAudit implements Auditable {
    ...
    public List<AuditableData> extractAuditData(CrudEnum crudEnum) {
        ...
        add(parameters, "listDescription", listDescription);
    ...
    public static ListMaintenanceReportParameterAudit from(ListMaintenanceFilterDto filter) {
        LegacyReportLocation location = filter.getLocation();
        return ListMaintenanceReportParameterAudit.builder()
                .dateFrom(filter.getDateFrom())
                .dateTo(filter.getDateTo())
                .listDescription(filter.getListDescription())
