...
public class ReportController implements ReportsApi {
    ...
    public ResponseEntity<JobAcknowledgement> createDurationReport(
        ...
        JobAcknowledgement acknowledgement = reportService.createDurationReport(durationFilterDto);
    ...
    public ResponseEntity<Resource> downloadReport(UUID jobId) {
        return ResponseEntity.ok()
                ...
                .body(new InputStreamResource(reportService.getDownloadStream(jobId)));
    }
}
