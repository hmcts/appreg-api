...
public interface ApplicationResultService {
    ...
    ApplicationResultDto create(Long listId, Long applicationId, ApplicationResultWriteDto dto, String userId);
    ApplicationResultDto update(Long listId, Long applicationId, Long resultId, ApplicationResultWriteDto dto, String userId);
