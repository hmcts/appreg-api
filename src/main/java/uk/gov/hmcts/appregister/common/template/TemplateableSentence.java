...
/**
 * A templateable sentence that can have its multiple templateable items substituted. This interface represents is a collection
 * of all templateable items in the sentence.
 */
public interface TemplateableSentence extends List<Templateable> {
     ...
     * @throws uk.gov.hmcts.appregister.common.exception.AppRegistryException The
     * first error that is seen
     */
     ...
     * @return The sentence with the templates substituted with the provided values. NOTE:
     * If the template can not be substituted the original sentence is returned
     */
