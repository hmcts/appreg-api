...
/**
 * Validates optional date ranges commonly used by list endpoints.
 * Throws a 400 if a provided "from..to" pair is inverted.
 */
@Component
public class DateRangeValidator {

    public void validate(LocalDate startDateFrom,
