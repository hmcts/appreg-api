...
public interface ApplicationEntryService {
     ...
     * officials are created if
     * provided as well as applicant and respondants are created if provided.
     ...
     * @throws uk.gov.hmcts.appregister.common.exception.AppRegistryException Data is validated for:-
     * - The application list found and/or in the correct state
     * - The application code is expecting a fee and it is provided
     * - Suitable Applicants is provided
     * - Suitable Respondent is provided if required
     * ......
     */
