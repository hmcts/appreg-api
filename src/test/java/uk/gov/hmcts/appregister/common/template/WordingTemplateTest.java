...
public class WordingTemplateTest {
    ...
    void testTemplateFailParsingDataTypeIncorrect() {
        AppRegistryException appRegistryException =
            Assertions.assertThrows(AppRegistryException.class, () -> WordingTemplateSentence.WordingTemplate.with(
    ...
    void testTemplateFailParsingTemplateFormatIncorrect() {
        AppRegistryException appRegistryException =
            Assertions.assertThrows(AppRegistryException.class, () -> WordingTemplateSentence.WordingTemplate.with(
                "{Wrong}"));
        Assertions.assertEquals(CommonAppError.WORDING_TEMPLATE_FORMAT_FAILURE, appRegistryException.getCode());
    }
