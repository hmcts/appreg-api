...
class RequestCachingFilterTest {
    ...
    @Test
    void givenNormalRequest_whenFiltered_thenRequestIsWrappedAndPayloadCanBeCached()
            throws Exception {
        byte[] payload =
                """
             {
    ...
    @Test
    void givenAlreadyCachedRequest_whenFiltered_thenSameRequestIsUsed() throws Exception {
        MockHttpServletRequest request = new MockHttpServletRequest();
