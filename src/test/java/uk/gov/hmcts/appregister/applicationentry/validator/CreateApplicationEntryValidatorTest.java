...
import uk.gov.hmcts.appregister.applicationentry.service.ApplicationEntryServiceImpl;
...
public class CreateApplicationEntryValidatorTest {
    ...
    @Mock
    private StandardApplicantRepository standardApplicantRepository;

    @InjectMocks
    private CreateApplicationEntryValidator createApplicationEntryValidator;
    ...
    void setUp() {
        ...
        when(applicationListRepository.findByUuid(appListUuid)).thenReturn(Optional.of(applicationList));
        ...
        when(feeRepository.findByReferenceBetweenDateWithOffsite(eq(applicationCode.getFeeReference()), notNull(),
                                                                 eq(entryCreateDto.getHasOffsiteFee()))).thenReturn(List.of(fee));

        when(standardApplicantRepository.findByApplicantCode(
            entryCreateDto.getStandardApplicantCode())).thenReturn(Optional.of(standardApplicant));

    }

    @Test
    void testValidateSuccess() {
        // set the applicant to null for the organisation and standard applicant so we use the person
        ...
        PayloadForCreate<EntryCreateDto> payload = PayloadForCreate.<EntryCreateDto>builder()
            .id(appListUuid).data(entryCreateDto).build();
    ...
    void testRespondentMutualExclusiveFail() {
        ...
        AppRegistryException appRegistryException = Assertions.assertThrows(AppRegistryException.class,
                                                                            () -> createApplicationEntryValidator.validate(payload));
        Assertions.assertEquals(AppListEntryError.RESPONDENT_CAN_ONLY_BE_ORGANISATION_OR_PERSON.getCode().getAppCode(),
    ...
    void testApplicantMutualExclusiveFail() {
        ...
        AppRegistryException appRegistryException = Assertions.assertThrows(AppRegistryException.class,
                                                                            () -> createApplicationEntryValidator.validate(payload));
        Assertions.assertEquals(AppListEntryError.APPLICANT_CAN_ONLY_BE_ORGANISATION_OR_PERSON.getCode().getAppCode(),
                                appRegistryException.getCode().getCode().getAppCode());
    }
    ...
    void testApplicantFeeNotDueFail() {
        ...
        AppRegistryException appRegistryException = Assertions.assertThrows(AppRegistryException.class,
                                                                            () -> createApplicationEntryValidator.validate(payload));
        Assertions.assertEquals(AppListEntryError.FEE_NOT_REQUIRED.getCode().getAppCode(),
                                appRegistryException.getCode().getCode().getAppCode());
    }
    ...
    void testApplicantFeeDueFail() {
        ...
        AppRegistryException appRegistryException = Assertions.assertThrows(AppRegistryException.class,
                                                                            () -> createApplicationEntryValidator.validate(payload));
        Assertions.assertEquals(AppListEntryError.FEE_REQUIRED.getCode().getAppCode(),
                                appRegistryException.getCode().getCode().getAppCode());
    }
    ...
    void testApplicantListNotExisting() {
        ...
        AppRegistryException appRegistryException = Assertions.assertThrows(AppRegistryException.class,
                                                                            () -> createApplicationEntryValidator.validate(payload));
        Assertions.assertEquals(AppListEntryError.APPLICATION_LIST_DOES_NOT_EXIST.getCode().getAppCode(),
                                appRegistryException.getCode().getCode().getAppCode());
    }
    ...
    void testApplicantListNotInCorrectStatus() {
        ...
        AppRegistryException appRegistryException = Assertions.assertThrows(AppRegistryException.class,
                                                                            () -> createApplicationEntryValidator.validate(payload));
        Assertions.assertEquals(AppListEntryError.APPLICATION_LIST_STATE_IS_INCORRECT_FOR_CREATE.getCode().getAppCode(),
                                appRegistryException.getCode().getCode().getAppCode());
    }
    ...
    void testStandardApplicantNotExist() {
        ...
        when(standardApplicantRepository.findByApplicantCode(entryCreateDto.getStandardApplicantCode())).thenReturn(Optional.empty());
        ...
        AppRegistryException appRegistryException = Assertions.assertThrows(AppRegistryException.class,
                                                                            () -> createApplicationEntryValidator.validate(payload));
        Assertions.assertEquals(AppListEntryError.STANDARD_APPLICANT_DOES_NOT_EXIST.getCode().getAppCode(),
                                appRegistryException.getCode().getCode().getAppCode());
    }
}
