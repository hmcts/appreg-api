...
public class ApplicationMapper {
    ...
    public ApplicationDto toReadDto(Application entity, FeePair fees) {
        ...
        ApplicationFeeRecord mainFeeRecord = entity.getFeeRecords().stream()
            .filter(r -> r.getApplicationFee() != null && !r.getApplicationFee().isOffset())
            .findFirst()
            .orElse(null);
        ...
        return new ApplicationDto(
            ...
            entity.getApplicant() != null ? identityDetailsMapper.toReadDto(entity.getApplicant()) : null,
            entity.getRespondent() != null ? identityDetailsMapper.toReadDto(entity.getRespondent()) : null,
    ...
    public Application createFromWriteDto(
        ...
        return Application.builder()
            .standardApplicant(applicant)
            .applicationCode(code)
            .applicant(dto.applicant() != null ? identityDetailsMapper.createFromWriteDto(dto.applicant()) : null)
            .respondent(dto.respondent() != null ? identityDetailsMapper.createFromWriteDto(dto.respondent()) : null)
    ...
    private IdentityDetails handleIdentityUpdate(IdentityDetailsWriteDto dto, IdentityDetails current) {
        if (dto == null) {
            return null;
        }
